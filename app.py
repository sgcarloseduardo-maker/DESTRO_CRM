            ...
            if caminho_img and os.path.exists(caminho_img):
                ...
                with b2:
                    with st.popover("📤 Trocar", use_container_width=True):
                        nova_img = st.file_uploader("Nova foto:", type=['png', 'jpg', 'jpeg', 'webp'], key=f"up_trocar_{uid}")
                ...
                with b2:
                    with st.popover("📤 Subir", use_container_width=True):
                        nova_img = st.file_uploader("Upload:", type=['png', 'jpg', 'jpeg', 'webp'], key=f"up_novo_{uid}")
